            ...
            <Paper className={classes.paper}>
              <form className={classes.form}>
                <Grid container spacing={2}><Grid item xs={12}>
                  ...
                  <Grid item xs={12} sm={12}>
                    <Typography variant="subtitle1">Subject</Typography></Grid>
                  <Grid item xs={12} sm={12}>
                    <TextField
                      name={'title'}
                      type={'text'}
                  ...
                  <Grid item xs={12} sm={12}>
                    <Select name={'priority'} defaultValue="default" onChange={handleChange} fullWidth variant="outlined">
                      <MenuItem disabled value="default">
                        --None--
                  </MenuItem>
                      {Priority.map((el) => {
...
export default Support
>>>>>>> 8d96d465a69b502b9928941e8d98e555e6f39093
