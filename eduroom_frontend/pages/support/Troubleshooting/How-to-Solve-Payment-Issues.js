...
import HowtoSolvePaymentIssues from '../../../components/support/troubleshooting/HowtoSolvePaymentIssues'
				...
				>
					<div id="nav">
						<div className="top">
							...
							<label style={{ marginLeft: '20px', marginRight: '20px' }}>&gt;</label>How to Solve Payment Issues
							<HowtoSolvePaymentIssues />
						</div>
					</div>
