								...
								{global.map((row) => {
									return (
										<div className="d-block">
											...
											<div className="detail" style={{ marginTop: '.5rem', fontWeight: 'bold' }}>
												{showDate} {currentMonth} - {row.enddate.substring(8, 10)} {currentMonth}
											</div>
											<div className="detail" style={{ marginTop: '0.5rem', fontWeight: 'bold', fontSize: '16px' }}>
												{row.place}
											</div>
										</div>
									)
