										...
										>
											<div className="courseBox">
												<div style={{ display: 'flex' }}>
													<div>
														<img src={c.coursepicture} width="130px" height="80px" style={{ marginRight: 30, marginTop: 5 }}></img>
													</div>
													<div>
									...
									<div style={{ display: 'flex', justifyContent: 'center' }}>
										...
										<div>
											...
											<div style={{ display: 'flex', flexDirection: 'row' }}>
												...
												<div className="col-6" style={{ display: 'flex', fontSize: 13, paddingTop: 7 }}>{il.count} courses</div>
											</div>
										</div>
									</div>
								</div>
