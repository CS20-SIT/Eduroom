    ...
    <span>
      ...
      >
        <DialogTitle id="form-dialog-title">
          {" "}
          <span style={sTitle}>Make Contest Announcement</span>
        </DialogTitle>

        <DialogContent>
          <DialogContentText>
            <span style={sText}>
              Anything to tell to our precious students? Maybe add some hints?,
              or tell them that this Contest is too hard. Please enter your
              detail here.
            </span>
          </DialogContentText>
          <TextField
