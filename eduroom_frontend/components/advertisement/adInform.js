					...
					<Paper style={{ margin: '0% 5% 5% 5%' }}>
						<div style={{ marginLeft: '50px' }}>
							<Grid container spacing={3}>
								...
								<Grid item xs={6}>
									<div
										className="ad-ad-header"
										style={{ paddingTop: '50px', paddingBottom: '50px', marginLeft: '60%' }}
									>
										<Link href="../advertisement/adpayment">
											Go to cart
											<img
									...
									<Grid item xs={4}>
										<div>
											...
											<Paper style={{ marginLeft: '5px', padding: 10, backgroundColor: '#EFF0F6' }}>
												<form>
													<InputBase
														onChange={(e) => setadInfo({ ...adInfo, adstartdate: e.target.value })}
														name="startdate"
														fullWidth
														autoFocus
														type={'datetime-local'}
									...
									<Grid item xs={4}>
										<div>
											...
											<Paper style={{ padding: 10, backgroundColor: '#EFF0F6' }}>
												<form>
													<InputBase
														onChange={(e) => setadInfo({ ...adInfo, adexpiredate: e.target.value })}
														name="expiredate"
														fullWidth
														autoFocus
														type={'datetime-local'}
							...
							<div>
								<Grid container spacing={3}>
									<Grid item xs={4}>
										<div>
											...
											<Paper style={{ marginTop: '5px', padding: 10, backgroundColor: '#EFF0F6' }}>
												<form>
													<InputBase
														onChange={(e) => setadInfo({ ...adInfo, contactemail: e.target.value })}
														name="contactEmail"
														fullWidth
														autoFocus
														type={'email'}
									...
									<Grid item xs={4}>
										<div className="img-spaceship"></div>
									</Grid>
								</Grid>
							</div>
							<div>
								<Grid item xs={4}>
									<div style={{ marginTop: '100px' }}>
										...
										<img
											src={adInfo.adimg ? URL.createObjectURL(adInfo.adimg) : null}
											alt={adInfo.adimg ? adInfo.adimg.name : null}
