				...
				<div className="adList">
					...
					<Paper style={{ margin: '0% 7% 7% 7%', background: 'rgba(255, 255, 255, 0.7)' }}>
						...
						<Grid container spacing={3} style={{ paddingBottom: '1%' }}>
							...
							<div className="circle" style={{ margin: '5% 0% 0% 60.5%', position: 'absolute' }}></div>
							<br></br>
							<div className="ad-ad-header" style={{ margin: '1% 0% 0% 20.7%' }}>
								paid
							</div>
							<div className="ad-ad-header" style={{ margin: '1% 0% 0% 23%' }}>
								wait
							</div>
							<div className="ad-ad-header" style={{ margin: '1% 0% 0% 20.7%' }}>
								success
