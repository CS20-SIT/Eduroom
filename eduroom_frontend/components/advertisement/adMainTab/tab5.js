	...
	return (
		<div>
			<div style={{ marginLeft: '40px', marginTop: '10px' }}>
				<a className="ad-ad-header">Need help getting started?</a>
				<br></br>
				<div style={{ marginTop: '15px' }}>
					<a>Here are a few resources to point you in the right direction.</a>
				</div>
				<br></br>

				<a className="ad-ad-header">FAQs</a>
								...
								<Grid item xs={12}>
									<Paper>
										<ListItem button onClick={handleClick1}>
											...
											{open1 ? (
												<img
													src={'https://www.flaticon.com/svg/static/icons/svg/566/566015.svg'}
													width="18"
													height="18"
												/>
											) : (
												<img
													src={'https://www.flaticon.com/svg/static/icons/svg/566/566014.svg '}
													width="18"
													height="18"
												/>
											)}
