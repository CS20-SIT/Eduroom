...
const Content = () => {
	...
	const handleSubmit = (e) => {
		...
		if (validator()) {
			...
			api
				.post('/api/forum/create', createForm)
				.then((res) => {
					console.log(res)
				})
				.catch((err) => {})
	...
	return (
		<Fragment>
			<General>
				...
				>
					<Paper style={{ height: '150px', width: '60%', opcacity: '100%' }}>
						<Link href="/advertisement/AdDetail">
				...
				>
					<button className="Get-Ad-button" type="MyCoupon" onClick={handleSubmit}>
