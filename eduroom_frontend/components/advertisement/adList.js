		...
		<Fragment>
			<General>
				<div className="adList">
					<div style={{ margin: '6% 7% 2% 7%' }}>
						<h1>List Of Advertisement</h1>
					</div>
					<Paper style={{ margin: '0% 7% 3% 7%', background: 'rgba(255, 255, 255, 0.7)' }}>
						<Grid
							...
							alignItems="center"
							justify="center"
							style={{ marginTop: '30px', padding: '2% 2% 2% 2%' }}
						>
							<div className="ad-border" style={{ marginTop: '30px' }}>
								<Grid container spacing={3} style={{ paddingLeft: '20px' }}>
									<Grid item xs={2} style={{ marginTop: '30px' }}>
										<img src="https://www.flaticon.com/svg/static/icons/svg/3064/3064943.svg" width="100px"></img>
									</Grid>
									<Grid item xs={8}>
										{' '}
										<h2>Advertisement01</h2>
										<br></br>
										<h4 style={{ marginTop: '-30px' }}>By Jeong Jaehyun</h4>
										<br></br>
										<h4 style={{ marginTop: '-40px' }}>Tags ad</h4>
										<Link href="../../advertisement/addetail" style={{ marginTop: '-40px' }}>
											see detail
										</Link>
									</Grid>
									<Grid item xs={2}>
										...
										<img
											src="https://www.flaticon.com/svg/static/icons/svg/1827/1827855.svg"
											width="80px"
