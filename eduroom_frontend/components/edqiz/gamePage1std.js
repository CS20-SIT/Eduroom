...
const Page1 = ({ goto, data, questionNumber, sentMessage, response, setAnswer, answer, pin }) => {
		...
		<Fragment>
			<div className="landing">
				<Grid container style={{ marginTop: '4vh' }}>
					...
					<Grid item xs={2} style={{ display: 'flex', justifyContent: 'center' }}></Grid>
				</Grid>
				<br />
					...
					<Grid container style={{ marginTop: '4vh', display: 'flex', alignItems: 'center' }}>
						...
						>
							<button
								...
								onClick={() => {
									setAnswerPage1(0), setAnswer(0), goto(3), setCountAnswer(), updateScore(0)
								}}
							>
