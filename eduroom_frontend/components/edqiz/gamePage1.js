...
const Page1 = ({ id, time, goto, data, questionNumber, sentMessage, response, setquestionNumber }) => {
		...
		<Fragment>
			<div className="landing">
				...
				<div style={{ display: 'flex', flexDirection: 'column' }}>
					...
					<Grid container style={{ marginTop: '4vh', display: 'flex', alignItems: 'center' }}>
						<Grid
							item
							xs={6}
							style={{
						...
						>
							<button className="buttonAnswer" style={{ backgroundColor: '#F39AC4' }} onClick={() => {}}>
								{data[questionNumber].ans[0]}
							</button>
						</Grid>
						<Grid item xs={6} style={{ display: 'flex', justifyContent: 'flex-start' }}>
							<button className="buttonAnswer" style={{ backgroundColor: '#D5C1FC' }}>
								{data[questionNumber].ans[1]}
							</button>
						</Grid>
					</Grid>
					<Grid container style={{ marginTop: '1vh', display: 'flex', alignItems: 'center' }}>
						<Grid
							item
							xs={6}
							style={{
						...
						>
							<button className="buttonAnswer" style={{ backgroundColor: '#FDD4C1' }}>
								{data[questionNumber].ans[2]}
							</button>
						</Grid>
						<Grid item xs={6} style={{ display: 'flex', justifyContent: 'flex-start' }}>
							<button className="buttonAnswer" style={{ backgroundColor: '#A6CEEE' }}>
