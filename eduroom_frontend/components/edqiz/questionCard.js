					...
					<div className="col-8">
						<div className="question-row flex-col">
							<div className="col-12 pb-3hf">
								<input type="text" placeholder="Your Question" value={data.question} onChange={handleChangeQuestion} />
							</div>
							<div className="col-12 flex1">
								...
								>
									<input id={'image' + index} type="file" accept="image/*" hidden={true} onChange={handleUploadFile} />
									{data.image ? (
										<div className="show-img">
											<img src="" id={'show-image' + index} className="mw600 mh300" />
										</div>
									) : (
										<div>
					...
					<div className="col-4">
						<div className="question-row">
							<div className="col-12 pb-6">
								<select name="time" onChange={handleChangeSelect} defaultValue="default">
							...
							<div className="col-12 pb-6">
								<select name="point" onChange={handleChangeSelect} defaultValue="default">
									<option value="default" disabled>
