...
const post = (props) => {
	return (
		<Fragment>
			...
			>
				<img src={props.data.avatar} className="myimgInPost" style={{ marginLeft: '4%', marginRight: '20px' }}></img>
				<div
					className="col"
					style={{
						width: 800,
				...
				>
					...
					>
						...
						<div style={{ paddingLeft: '0.5rem' }}>{moment(props.data.date).fromNow()}</div>
					</div>
					<div style={{ fontSize: 18 }}>{props.data.comment}</div>
				</div>
			</div>
