		...
		return (
			<React.Fragment>
				<Grid item xs={2} className="button" onClick={handleClick} variant="outlined">
					...
					>
						<div>
							<img src="/images/forum/Math.svg"></img>
						</div>
				...
				<Grid item xs={2}>
					...
					>
						<div>
							<img src="/images/forum/Science.svg"></img>
						</div>
				...
				<Grid item xs={2}>
					...
					>
						<div>
							<img src="/images/forum/Language.svg"></img>
						</div>
						<div style={{ paddingTop: '6px', fontSize: '0.8em', fontWeight: '600' }}>LANGUAGE</div>
					</Paper>
				</Grid>
				<Grid item xs={2}>
					<Paper elevation={0} className={classes.paper} style={{ border: '2px solid #a880f7', borderRadius: '10px' }}>
						<div>
							<img src="/images/forum/Language.svg"></img>
						</div>
		...
		<Fragment>
			<div className={classes.root}>
				<Grid container spacing={0}>
					<Grid container item xs={12} spacing={1} style={{ display: 'flex', flexWrap: 'nowrap' }}>
