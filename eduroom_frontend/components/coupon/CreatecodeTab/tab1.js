...
const Content = () => {
	...
	return (
		<div>
			<div className="ad-ad-header" style={{ marginLeft: '43%' }}>
				<h3>Create Code</h3>
			</div>
			<div className="ad-ad-description" style={{ margin: '-2% 0% 1% 20%' }}>
				<Grid container spacing={3} style={{ marginTop: '20px' }}>
					<Grid item xs={6}>
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									onChange={(e) => setcouponInfo({ ...couponInfo, codename: e.target.value })}
									name="codename"
									fullWidth
									autoFocus
									type={'text'}
					...
					<Grid item xs={6} style={{ marginLeft: '-10%' }}>
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									onChange={(e) => setcouponInfo({ ...couponInfo, discount: e.target.value })}
									name="discount"
									fullWidth
									autoFocus
									type={'Number'}
				...
				<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '70%', marginTop: '1%' }}>
					<form>
						<InputBase
							onChange={(e) => setcouponInfo({ ...couponInfo, description: e.target.value })}
							name="description"
							fullWidth
							autoFocus
							type={'text'}
				...
				<Grid container spacing={3} style={{ marginTop: '20px' }}>
					<Grid item xs={6}>
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									onChange={(e) => setcouponInfo({ ...couponInfo, duration: e.target.value })}
									name="duration"
									fullWidth
									autoFocus
									type={'number'}
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									onChange={(e) => setcouponInfo({ ...couponInfo, minprice: e.target.value })}
									name="minimumPrice"
									fullWidth
									autoFocus
									type={'number'}
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									...
									onChange={(e) => setcouponInfo({ ...couponInfo, coinprice: e.target.value })}
									name="coinprice"
									fullWidth
									autoFocus
									type={'number'}
						...
						<Paper style={{ padding: 10, backgroundColor: '#EFF0F6', width: '60%', marginTop: '1%' }}>
							<form>
								<InputBase
									...
									onChange={(e) => setcouponInfo({ ...couponInfo, uselimit: e.target.value })}
									name="uselimit"
									fullWidth
									autoFocus
									type={'number'}
