...
export default function FullWidthTabs() {
	...
	const [background, setBackground] = useState('/images/big-bg.svg')
		...
		<Fragment>
			<div className="background">
				...
				<div style={{ margin: ' 0% 5% 5% 5% ', paddingBottom: '20px', backgroundColor: 'transparent' }}>
					...
					></div>
					<Tabs value={value} onChange={handleChange} indicatorColor="secondary" textColor="secondary" centered={true}>
