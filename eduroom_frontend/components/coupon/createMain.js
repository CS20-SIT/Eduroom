...
import Tab1 from './CreatecodeTab/tab1'
import Tab2 from './CreatecodeTab/tab2'
...
export default function FullWidthTabs() {
	...
	return (
		<Fragment>
			...
			<Paper style={{ margin: '5% 5% 5% 5%', padding: '1.5%', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
				<div
					style={{
