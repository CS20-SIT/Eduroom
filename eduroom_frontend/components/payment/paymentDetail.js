                                ...
                                <Grid item xs={6} className="divleft">
                                    <div style={{ paddingLeft: 40 }}>
                                        <div style={{ marginLeft: 15, marginTop: 20 }}>
                                            ...
                                            <div className="col-6">
                                                <select name="country" style={{ width: '410px', backgroundColor: "white", border: '0px solid', cursor: 'pointer', boxShadow: '0 5px 10px 0 rgba(0, 0, 0, 0.3)' }} className="country">
                                                    <option value="default" disabled selected >Your Country</option>
                                ...
                                <Grid item xs={6} style={{ paddingTop: 30 }}>
                                    <div style={{ display: 'flex', justifyContent: 'center'}}>
                                        <div className="whitebox" >
                                            <h1 style={{ fontSize: 20, marginLeft: 20, fontWeight: 700 }}>Summary</h1>

                                            <div style={{ display: 'flex', justifyContent: 'flex-start', fontWeight: 500, margin: '10px 0px 10px 50px' }}>
                                                <div style={{ marginRight: 95 }} className="col-6">Original Price</div>
                                                <div className="col-6">฿900</div>

                                            </div>

                                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                                <input type="text" className="whiteboxInput"
                                                    placeholder="Enter coupon code"
                                                    style={{ border: '1.5px solid', borderColor: '#FB9CCB', fontSize: 16 }}
                                                    name="secure"
                                                    type={"text"}
                                                />
                                                <Button variant="contained" style={{ backgroundColor: '#FB9CCB', color: 'white', width: 80, borderRadius: 0 }}
                                                >Apply</Button>
                                            </div>
                                            <div style={{ display: 'flex', justifyContent: 'flex-start', fontWeight: 500, margin: '10px 0px 5px 50px' }}>
                                                <div style={{ marginRight: 132 }} className="col-6">Coupon</div>
                                                <div style={{ color: '#9593A0' }} className="col-6">-10%</div>
                                            </div>

                                            <div style={{ display: 'flex', justifyContent: 'flex-start', fontWeight: 500, margin: '10px 0px 10px 50px' }}>
                                                <div style={{ marginRight: 57 }} className="col-6">Coupon discounts</div>
                                                <div style={{ color: '#9593A0' }} className="col-6">-฿850</div>
                                            </div>

                                            <hr style={{ width: 300, marginBottom: 10 }}></hr>

                                            <div style={{ display: 'flex', justifyContent: 'flex-start', fontWeight: 500, margin: '10px 0px 20px 50px' }}>
                                                <div style={{ marginRight: 160 }} className="col-6">Total</div>
                                                <div style={{ color: 'black' }} className="col-6">฿500</div>
                                            </div>
                                            <div className="text">
