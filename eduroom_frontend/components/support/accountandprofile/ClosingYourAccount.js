					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									This article outlines how you can close your Udemy account. If you're having trouble with the site, or
									if there's anything we can help you with before you close your account, please contact Udemy Support.
								</p>
								<p>
									Please note that by closing your Udemy account you will lose access to all the courses you’ve enrolled
									in, including purchased courses.  If a course was purchased within the past 30 days, however, you can
									request a refund before closing your account.
								</p>
								<p>
									For a complete list of the information we collect and how it is used, please refer to our Privacy and
									Cookie Policy.
								</p>
								...
								<ol>
									...
									<li> Enter your password and click Close Account again. </li>
								</ol>
