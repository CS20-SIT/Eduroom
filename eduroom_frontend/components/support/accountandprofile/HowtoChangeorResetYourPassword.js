					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									This article explains how you can change the password for your Udemy account, and request a reset
									password email if you have forgotten it.
								</p>
								<h3>How to reset your password</h3>
								<p>
									If you can’t remember the password for your Udemy account, you can request a reset password email from
									the login page:
								</p>
								<ol>
									{' '}
									<li>Move your cursor to the top right of Udemy's homepage, then click on Login </li>
									...
									<li>Check your inbox for the reset password email and complete the steps to change your password </li>
								</ol>
