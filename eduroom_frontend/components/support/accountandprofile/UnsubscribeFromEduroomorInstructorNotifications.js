					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									If you no longer wish to receive certain notifications from Udemy and instructors, you can unsubscribe
									from them by changing your notification settings.
								</p>
								...
								<ol>
									...
									<li>
										Click Account Settings in the dropdown menu and then Notifications on the left hand-side of the
										page.
									</li>
									<li>
										Select the notifications you wish to receive. If you don't wish to receive any promotional emails,
										however, then click on the box beside Don't send me any promotional emails.
									</li>
									<li>Click Save.</li>
								</ol>
