					...
					<Grid item xs={9}>
						...
						>
							...
							<Link href="/support/Selling&Promotion/Instructors:-Eduroom's-Pricing-Tiers-For-Courses">
								<p>Instructors: Eduroom's Pricing Tiers For Courses</p>
							</Link>

							<Link href="/support/Selling&Promotion/Why-Can't-I-Send-my-Educational-Announcementor-Promotional-Email">
								<p>Why Can't I Send my Educational Announcement or Promotional Email?</p>
							</Link>

							<Grid container justify="flex-end">
								<img
									src="/images/sellingandpromotion.svg"
									style={{ marginRight: theme.spacing(8), width: '45%' }}
								></img>
							</Grid>
						</Paper>
					</Grid>
