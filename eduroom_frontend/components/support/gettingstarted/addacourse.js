					...
					<Grid item xs={9} style={{ paddingRight: theme.spacing(13) }}>
						...
						>
							<Typography>
								{' '}
								<p>
									Adding free or paid courses to your wishlist is a quick and easy way to save a course for later, and
									enroll in it when you’re ready. This article outlines how you can add courses to your wishlist from
									the course card, course landing page or from your shopping cart.
								</p>
								...
								<p>
									When you decide you would like to enroll in the course, you can return it to your Shopping Cart by
									clicking on Move to Cart.
								</p>
								...
								<p>
									To remove a courses from the Wishlist, click the red heart located on the course card. The course will
