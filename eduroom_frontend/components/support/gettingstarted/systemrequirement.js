					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									You can access your Udemy courses from various devices and platforms, on both PC and Mac desktops /
									laptops, as well as Android and iOS mobile devices. Our system requirements for these follow below.
								</p>
								<h4>Minimum System Requirements</h4>
								<li style={{ marginLeft: '25px' }}>
									<p>The latest Chrome, Firefox, Safari, Edge, Opera or IE11 for desktop/laptop</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>A broadband connection with a minimum speed of 5Mbit or 800kbps</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>Please note that Flash Player is not required</p>
								</li>
								<h4>PC Specific Requirements</h4>
								<li style={{ marginLeft: '25px' }}>
									<p>Platform: Windows 8 or higher with the latest updates installed</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>RAM: 4GB or more</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>Video: Graphics output capability</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>Sound: Sound output capability</p>
								</li>
								<h4>Mac Specific Requirements</h4>
								<li style={{ marginLeft: '25px' }}>
									<p>Platform: Mac OS X 10.12 or higher with the latest updates installed</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>RAM: 4GB or more</p>
								</li>
								...
								<li style={{ marginLeft: '25px' }}>
									<p>iOS 12.0 and above</p>
								</li>
								<li style={{ marginLeft: '25px' }}>
									<p>Android 6.0 and above</p>
								</li>
								...
								<p>
									To find out more about your specific system, this site will tell you which browser and OS you're
									currently using.
								</p>
