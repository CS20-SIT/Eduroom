                ...
                <Grid container>
                    ...
                    <Grid item xs={9} style={{ paddingRight: "100px" }}>
                        ...
                        >
                            <Typography>
                                {" "}
                                <p>Many instructors add supplemental resources to their lectures as a means to enhance the learning experience of the course. </p>
<p>These resources can quickly be accessed and viewed on the Udemy iOS app. </p>
<h3>How to Access Resources on The iOS App</h3>
<p>Lectures that include supplementary resources will have Resources posted under the lecture title, on the course curriculum page. </p>

<p>To access the resources, tap on the lecture title and hold for a moment or two. An options menu will appear. Tap on Resources for Lectures.</p>

<p>A list of the available resources will come up.</p>

<p>Tap on the resource(s) you would like to review.</p>
<p>If you're having trouble accessing the file, or if something doesn't look right, please contact the instructor or our support team.</p>
