...
<ol> <li>Navigate to the course dashboard</li>
  <li>Swipe to the More tab</li>
  <li>Tap the Resources section </li>
 <li>You will see a list of the resources files that are available to view. If the resources are PDF files, you can go to step 5 to learn how to download them to your mobile device.</li>
  <li>Tap the vertical ellipses in the upper right side of the screen </li>
 <li>Tap Download</li></ol> 


<p>To access the downloaded PDF file outside of the app, please go to Internal storage &gt; Download and open it with your reader program.</p>
