				...
				<Grid container>
					...
					<Grid item xs={9}>
						...
						>
							...
							<p>
								<Link href="/support/Mobile/Unrecognized-Lecture-Format">Unrecognized Lecture Format</Link>
							</p>

							<Link href="/support/Mobile/How-to-Access-Resources-on-The-Eduroom-iOS-App">
								<p>How to Access Resources on The Eduroom iOS App</p>
							</Link>

							<Link href="/support/Mobile/Disable-Push-Notifications-on-iOS">
								<p>Disable Push Notifications on iOS</p>
							</Link>
							<Link href="/support/Mobile/Manually-Mark-a-Lecture-as-Complete-on-iOS-Devices">
								<p>Manually Mark a Lecture as Complete on iOS Devices</p>
							</Link>
							<Link href="/support/Mobile/How-to-Access-Resources-on-The-Eduroom-Android-App">
								<p>How to Access Resources on The Eduroom iOS App</p>
							</Link>
