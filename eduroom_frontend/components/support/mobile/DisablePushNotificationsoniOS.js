					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									Tired of the pop-ups on your iPhone or iPad? This is an easy fix - all you need to do is disable your
									notifications from Udemy. If you want to learn how to opt out of e-mail notifications, please click
									here.
								</p>
								...
								<ol>
									{' '}
									<li>From your home screen, tap Settings </li>
									<li> Hit Notifications.</li>
								</ol>
