...
const UnrecognizedLectureFormat = () => {
            ...
            <Grid container style={{ marginTop: "30px" }}>
                <Grid container>
                    <Typography style={{ marginLeft: "20px" }}>
                        {" "}
                        <h1>Unrecognized Lecture Format</h1>
                    </Typography>
                    <Grid item xs={9} style={{ paddingRight: "100px" }}>
                        ...
                        >
                            <Typography>
                                {" "}
                                <p>If you see this message while taking a course on the Udemy app, it means that the lecture you're trying to view is a file type that is not supported by iOS. This happens most often in our programming courses. For example, if an instructor uploads a Python file (.py) as a lecture, the file will not be available on the app.</p>

<p>To view this lecture, please sign in to Udemy from your computer.</p>
...
export default UnrecognizedLectureFormat;
