						...
						<Link href="/support/Instructor-Payment">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/instructorpayments.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Instructor Payments
					...
					>
						<Link href="/support/Selling&Promotion">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/sellingandpromotion.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Selling & Promotion
					...
					>
						<Link href="/support/Quality-Standards">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/qualitystandards.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Quality Standards
					...
					>
						<Link href="/support/Course-Building">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/coursebuilding.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Course Building
					...
					>
						<Link href="/support/Course-Management">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/coursemanagement.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Course Management
					...
					>
						<Link href="/support/Trust&Safety">
							<Button style={{ width: '260px', height: '220px' }} variant="outlined">
								<Grid container sm={12}>
									<Grid item sm={12}>
										<img src="/images/trustandsafety.svg" style={{ height: '120px' }} />
										<br></br>
									</Grid>
									<Grid item sm={12}>
										Trust & Safety
