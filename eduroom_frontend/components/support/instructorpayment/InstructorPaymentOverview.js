					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									All Udemy instructors are contracted with the U.S.-based Udemy, Inc. Udemy pays instructors through
									PayPal and Payoneer. For more information on setting up your payment method, please refer to this
									article.
								</p>
								...
								<p>
									7.As an instructor, you are free to publish as many free and paid courses as you like.  We believe in
									a sustainable partnership, in which instructors are rewarded for creating amazing content and bringing
									students to the platform, and Udemy is rewarded for driving traffic to all our instructors.
								</p>
								<p>
									You can view expected payment dates and the payment amount for a specific month on your Revenue
									Report. To see a more detailed sales report for a specific month, simply click on the month in the
									Time Period column. 
								</p>
