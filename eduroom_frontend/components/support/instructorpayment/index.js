					...
					<Grid item xs={9}>
						...
						>
							...
							<Link href="/support/Instructor-Payment/How-Does-Eduroom-Handle-VAT-GST">
								<p>How Does Eduroom Handle VAT / GST?</p>
							</Link>

							<Link href="/support/Instructor-Payment/How-do-Instructors-Earn-From-Resellers">
								<p>How do Instructors Earn From Resellers?</p>
							</Link>
							<Link href="/support/Instructor-Payment/Missing-Instructor-Payments">
								<p>Missing Instructor Payments</p>
							</Link>
							<Link href="/support/Instructor-Payment/Instructor-Payment-Overview">
								<p>Instructor Payment Overview</p>
							</Link>
