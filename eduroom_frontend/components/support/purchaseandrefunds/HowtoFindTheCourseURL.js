					...
					<Grid item xs={9} style={{ paddingRight: '100px' }}>
						...
						>
							<Typography>
								{' '}
								<p>
									If you need to locate the URL of a course you’re taking, this article explains how you can do so from
									the course player on a web browser.
								</p>
								<h3>How to locate the course URL on a web browser</h3>
								<p>
									The course URL is the web address of the course page. You can copy the URL for the course, which
									appears above the course player in your web browser.
								</p>
								<p>Steps on how to access the course player can be read here.</p>
								<h3>How to locate the course URL on a mobile device</h3>
								<p>
									Please note that the course URL is only visible on a web browser and not in the Udemy mobile app. To
									locate the course URL while using a mobile device, please log into Udemy.com on a web browser and
