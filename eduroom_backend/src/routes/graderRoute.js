...
router.post('/ptc', uploadToGCSHandler('question_testcase/'), jwtAdminAuthenticate, pTestcase)
router.get('/', test)
...
router.post('/ccontestexistquestion', jwtAdminAuthenticate, pContestExistingQuestion)
...
router.get('/getContestRanking', gContestRanking)
