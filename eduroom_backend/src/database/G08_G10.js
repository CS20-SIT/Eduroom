...
(
 ...
 CONSTRAINT PK_oi_anwer PRIMARY KEY ( userId ),
...
(
 ...
 totalSubmit  int NOT NULL,
 userId       uuid NOT NULL,
 CONSTRAINT PK_acm_anwer PRIMARY KEY ( userId ),
...
(
 ...
 CONSTRAINT PK_announcements_contest PRIMARY KEY ( examAnnNo ),
...
(
 ...
 time       int NOT NULL,
 score      int NOT NULL,
 CONSTRAINT PK_qa_anwer PRIMARY KEY ( attemptId, testcaseNo ),
...
(
 ...
 adminId      uuid NOT NULL,
 CONSTRAINT PK_table_2 PRIMARY KEY ( examNo ),
...
(
 ...
 score      int NOT NULL,
 attempt_at time NOT NULL,
 status     varchar(50) NOT NULL,
 time       int NOT NULL,
 memory     int NOT NULL,
 language   varchar(50) NOT NULL,
 code       text NOT NULL,
 CONSTRAINT PK_table_4 PRIMARY KEY ( attemptId ),
...
(
 ...
 questionId     int NOT NULL,
 CONSTRAINT PK_questions_contest PRIMARY KEY ( id ),
...
exports.createG08G10Table = async () => {
  try {
...
const createTable_OI_rank = async () => {
  try {
...
const createTable_ACM_rank = async () => {
  try {
...
const createTable_contest_announcements = async () => {
  try {
...
const createTable_announcements = async () => {
  try {
...
const createTable_question_attempt_testcase = async () => {
  try {
...
const createTable_adminLog = async () => {
  try {
...
const createTable_contest = async () => {
  try {
...
const createTable_question_attempt = async () => {
  try {
...
const createTable_contest_question = async () => {
  try {
...
const createTable_contest_attempt = async () => {
  try {
...
const createTable_questionTestCases = async () => {
  try {
...
const createTable_questions = async () => {
  try {
...
const createTable_questionTag = async () => {
  try {
...
const createTable_questionSample = async () => {
  try {
